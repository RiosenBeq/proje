  ...
  return (
    ...
    >
      <header className="mb-24 relative">
        <div className="absolute -top-12 -left-4 text-[120px] font-headline font-bold text-slate-200 select-none pointer-events-none uppercase">Referans</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <article className="group cursor-pointer">
          <div className="relative overflow-hidden aspect-[4/3] mb-6 rounded-lg">
            ...
            <div className="absolute bottom-4 left-4 z-20 flex gap-2">
              <span className="bg-white/85 backdrop-blur-md px-3 py-1 rounded text-[10px] font-label text-slate-900 tracking-widest uppercase">Stüdyo</span>
              <span className="bg-white/85 backdrop-blur-md px-3 py-1 rounded text-[10px] font-label text-primary-container tracking-widest uppercase">2023</span>
            </div>
          </div>
          <h2 className="text-2xl font-headline font-bold text-slate-900 mb-2 uppercase tracking-tight group-hover:text-primary-container transition-colors">Studio Alpha - İstanbul</h2>
        ...
        <article className="group cursor-pointer md:mt-24">
          <div className="relative overflow-hidden aspect-[4/3] mb-6 rounded-lg">
            ...
            <div className="absolute bottom-4 left-4 z-20 flex gap-2">
              <span className="bg-white/85 backdrop-blur-md px-3 py-1 rounded text-[10px] font-label text-slate-900 tracking-widest uppercase">Canlı Müzik</span>
              <span className="bg-white/85 backdrop-blur-md px-3 py-1 rounded text-[10px] font-label text-primary-container tracking-widest uppercase">2024</span>
            </div>
          </div>
          <h2 className="text-2xl font-headline font-bold text-slate-900 mb-2 uppercase tracking-tight group-hover:text-primary-container transition-colors">Club Nexus - İzmir</h2>
        ...
        <article className="group cursor-pointer">
          <div className="relative overflow-hidden aspect-[4/3] mb-6 rounded-lg">
            ...
            <div className="absolute bottom-4 left-4 z-20 flex gap-2">
              <span className="bg-white/85 backdrop-blur-md px-3 py-1 rounded text-[10px] font-label text-slate-900 tracking-widest uppercase">Konferans</span>
              <span className="bg-white/85 backdrop-blur-md px-3 py-1 rounded text-[10px] font-label text-primary-container tracking-widest uppercase">2023</span>
            </div>
          </div>
          <h2 className="text-2xl font-headline font-bold text-slate-900 mb-2 uppercase tracking-tight group-hover:text-primary-container transition-colors">Grand Auditorium - Ankara</h2>
