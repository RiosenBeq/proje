      ...
      '@graph': [
        {
          '@type': 'CreativeWork',
          name: p.name,
          url: `https://onmuzikproje.com/projeler/${p.slug}`,
          ...
          creator: { '@id': 'https://onmuzikproje.com/#business' },
          image: p.hero.image,
        ...
        },
        {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: 'Projeler', item: 'https://onmuzikproje.com/portfolyo' },
            { '@type': 'ListItem', position: 3, name: p.name, item: `https://onmuzikproje.com/projeler/${p.slug}` },
          ],
        },
      ],
    },
