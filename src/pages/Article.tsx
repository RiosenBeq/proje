  ...
  useSeo(a ? {
    ...
    jsonLd: {
      ...
      '@graph': [
        {
          '@type': 'BlogPosting',
          '@id': `https://onmuzikproje.com/bilgi-merkezi/${a.slug}#article`,
          headline: a.title,
          description: a.summary,
          articleSection: a.category,
          datePublished: a.publishedAt,
          dateModified: a.publishedAt,
          author: { '@id': 'https://onmuzikproje.com/#org' },
        ...
        },
        {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: 'Bilgi Merkezi', item: 'https://onmuzikproje.com/bilgi-merkezi' },
            { '@type': 'ListItem', position: 3, name: a.title, item: `https://onmuzikproje.com/bilgi-merkezi/${a.slug}` },
          ],
        },
      ],
    },
