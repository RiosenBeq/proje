  ...
  return (
    ...
    >
      <header className="mb-24 relative">
        <div className="absolute -top-12 -left-4 text-[120px] font-headline font-bold text-slate-200 select-none pointer-events-none uppercase">Archive</div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
          ...
          <article className="group relative">
            ...
            <div className="relative grid md:grid-cols-5 gap-8">
              <div className="md:col-span-2 overflow-hidden rounded-lg aspect-[4/5] relative">
                ...
                <div className="absolute top-4 left-4 bg-white/85 backdrop-blur-md px-3 py-1 rounded text-[10px] font-label text-primary-container tracking-widest uppercase">ID: AT-01</div>
              </div>
              <div className="md:col-span-3 flex flex-col">
                <h2 className="text-3xl font-headline font-bold text-slate-900 mb-4 uppercase tracking-tight">Akustik Tasarım</h2>
                ...
                <div className="grid grid-cols-2 gap-4 mt-auto">
                  <div className="museum-label pl-4 py-2">
                    ...
                    <div className="text-xl font-headline font-medium text-slate-900">0.45s - 0.60s</div>
                  </div>
                  <div className="museum-label pl-4 py-2">
                    <div className="text-[10px] font-label text-primary-container uppercase tracking-widest mb-1">Frekans Aralığı</div>
                    <div className="text-xl font-headline font-medium text-slate-900">20Hz - 22kHz</div>
                  </div>
                  <div className="museum-label pl-4 py-2">
                    <div className="text-[10px] font-label text-primary-container uppercase tracking-widest mb-1">Materyal</div>
                    <div className="text-xl font-headline font-medium text-slate-900">Hibrit Polimer</div>
                  </div>
                  <div className="museum-label pl-4 py-2">
                    <div className="text-[10px] font-label text-primary-container uppercase tracking-widest mb-1">İzolasyon</div>
                    <div className="text-xl font-headline font-medium text-slate-900">-55dB (STC)</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <article className="group relative">
            ...
            <div className="relative grid md:grid-cols-5 gap-8">
              <div className="md:col-span-2 overflow-hidden rounded-lg aspect-[4/5] relative">
                ...
                <div className="absolute top-4 left-4 bg-white/85 backdrop-blur-md px-3 py-1 rounded text-[10px] font-label text-primary-container tracking-widest uppercase">ID: PS-04</div>
              </div>
              <div className="md:col-span-3 flex flex-col">
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-[10px] font-label text-slate-500 uppercase tracking-[0.3em]">Official Partner</span>
                  <div className="h-[1px] flex-grow bg-white/10"></div>
                  <span className="text-[12px] font-headline font-bold text-slate-900 tracking-tighter">PIONEER PRO AUDIO</span>
                </div>
                <h2 className="text-3xl font-headline font-bold text-slate-900 mb-4 uppercase tracking-tight">Profesyonel Ses</h2>
                ...
                <div className="grid grid-cols-2 gap-4 mt-auto">
                  <div className="museum-label pl-4 py-2">
                    ...
                    <div className="text-xl font-headline font-medium text-slate-900">136 dB Peak</div>
                  </div>
                  <div className="museum-label pl-4 py-2">
                    <div className="text-[10px] font-label text-primary-container uppercase tracking-widest mb-1">Dispersion</div>
                    <div className="text-xl font-headline font-medium text-slate-900">110° x 10°</div>
                  </div>
                  <div className="museum-label pl-4 py-2">
                    <div className="text-[10px] font-label text-primary-container uppercase tracking-widest mb-1">Processing</div>
                    <div className="text-xl font-headline font-medium text-slate-900">96kHz DSP</div>
                  </div>
                  <div className="museum-label pl-4 py-2">
                    <div className="text-[10px] font-label text-primary-container uppercase tracking-widest mb-1">Amplifier</div>
                    <div className="text-xl font-headline font-medium text-slate-900">Class-D Peak</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="lg:col-span-5 flex flex-col gap-8 lg:sticky lg:top-32">
          <div className="glass-card p-8 rounded-2xl border border-slate-200 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-headline font-bold text-slate-900 mb-4 uppercase tracking-tight">Güvenlik ve Kontrol</h3>
              ...
              <ul className="space-y-4">
                <li className="flex items-center justify-between group">
                  <span className="text-[10px] font-label text-slate-500 group-hover:text-primary transition-colors">Yapay Zeka Destekli Takip</span>
                  <span className="text-xs font-headline text-slate-900">Aktif</span>
                </li>
                <li className="flex items-center justify-between group">
                  <span className="text-[10px] font-label text-slate-500 group-hover:text-primary transition-colors">Biyometrik Erişim Kontrolü</span>
                  <span className="text-xs font-headline text-slate-900">L5 Secure</span>
                </li>
                <li className="flex items-center justify-between group">
                  <span className="text-[10px] font-label text-slate-500 group-hover:text-primary transition-colors">Akıllı Aydınlatma Entegrasyonu</span>
                  <span className="text-xs font-headline text-slate-900">DALI-2</span>
                </li>
                <li className="flex items-center justify-between group">
                  <span className="text-[10px] font-label text-slate-500 group-hover:text-primary transition-colors">Uzak İzleme ve Yönetim</span>
                  <span className="text-xs font-headline text-slate-900">Mobil/Web</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-surface-container-lowest p-8 rounded-2xl border border-slate-200 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <div className="text-[10px] font-label text-slate-900 uppercase tracking-widest mb-6">Hata Payı Politikası</div>
      ...
      <section className="mt-48 pt-24 border-t border-slate-200">
        <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16">
          <div>
            ...
            <h2 className="text-4xl font-headline font-bold text-slate-900 uppercase tracking-tighter">Ekipman Envanteri</h2>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-px bg-slate-100 border border-slate-200">
          <div className="bg-background p-6 hover:bg-surface-container-low transition-colors">
            <div className="text-[10px] font-label text-slate-400 uppercase mb-4 tracking-widest">Brand</div>
            <div className="text-slate-900 font-headline font-medium">Pioneer Pro</div>
          </div>
          <div className="bg-background p-6 hover:bg-surface-container-low transition-colors">
            <div className="text-[10px] font-label text-slate-400 uppercase mb-4 tracking-widest">Type</div>
            <div className="text-slate-900 font-headline font-medium">Point Source</div>
          </div>
          <div className="bg-background p-6 hover:bg-surface-container-low transition-colors">
            <div className="text-[10px] font-label text-slate-400 uppercase mb-4 tracking-widest">Origin</div>
            <div className="text-slate-900 font-headline font-medium">UK / Japan</div>
          </div>
          <div className="bg-background p-6 hover:bg-surface-container-low transition-colors">
            <div className="text-[10px] font-label text-slate-400 uppercase mb-4 tracking-widest">Support</div>
            <div className="text-slate-900 font-headline font-medium">24/7 Remote</div>
          </div>
          <div className="bg-background p-6 hover:bg-surface-container-low transition-colors hidden lg:block">
            <div className="text-[10px] font-label text-slate-400 uppercase mb-4 tracking-widest">Warranty</div>
            <div className="text-slate-900 font-headline font-medium">5 Years Ltd.</div>
          </div>
        </div>
      </section>
    </motion.main>
