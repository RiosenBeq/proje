...
export type ProductDetail = {
  ...
  categoryHref: string;
  /** Üst kategori altındaki spesifik alt-etiket (örn. "Saç Bakımı", "Süpürge").
      Detay sayfa hero'sunda küçük chip, JSON-LD'de category path'inin son segmenti. */
  subCategory: string;
  /** Hedef kullanıcı profili - 1 cümlelik özet (kim için, ne için).
      H1 altında italic micro-text, JSON-LD audience.audienceType. */
  audience: string;
  /** SEO için ürüne özel uzun-kuyruk anahtar kelimeler (8-12 phrase).
      Page meta keywords + Product JSON-LD keywords. */
  keywords: string[];
...
export const PRODUCTS: ProductDetail[] = [
  ...
  // 1 - Dyson Airwrap ID Ceramic Pink (saç şekillendirici)
  {
    ...
    audience: 'Düğün, davet ve özel günler için profesyonel kuaför sonucu arayan gelinler, bireyler ve etkinlik organizatörleri.',
    keywords: ['dyson airwrap kiralama', 'sac sekillendirici kiralama', 'gelin sac kiralama', 'dugun sac sekillendirici', 'coanda hava akimi', 'kuafor sonucu evde', 'ceramic pink airwrap', 'profesyonel sac sekillendirme', 'aylik sac sekillendirici', 'on music kiralama'],
    series: 'Saç şekillendirici · Dyson Airwrap serisi',
    short: 'Dyson Coanda hava akımı teknolojisiyle saçı aşırı ısıdan korur. Bukle, dalga, düzleştirme ve hacim - 6 aksesuar ile tek cihazda profesyonel kuaför sonucu. Düğün, davet ve özel etkinlik için aylık kiralama 1.450 TL\'den - Hızla Kirala\'da hemen kirala.',
  ...
  // 2 - Dreame AirStyle Pro saç şekillendirici
  {
    ...
    categoryHref: `${PARTNER_BASE}/urunler/kategori/sac-sakal-bakim-urunleri-kiralama`,
    subCategory: 'Saç Bakımı',
    audience: 'Evde profesyonel kuaför sonucu arayan, 7 farklı stili tek cihazda denemek isteyen kullanıcılar.',
    keywords: ['dreame airstyle pro kiralama', '7 aksesuarli sac sekillendirici', 'negatif iyon sac', '110000 rpm sac motoru', 'ev kuafor seti', 'dreame premium sac', 'sac kurutma sekillendirme', 'dijital ekran sac sekillendirici', 'aylik sac kirala', 'hizla kirala dreame'],
    series: 'Saç şekillendirici · Dreame AirStyle serisi',
    short: 'Dreame AirStyle Pro, kurutma + bukle + dalga + hacim + düzleştirme tek cihazda. 7 farklı aksesuarla tüm saç tiplerine uygun şekillendirme; akıllı sıcaklık kontrolü ile saç sağlığını koruyan kiralık premium şekillendirici. Aylık 1.250 TL\'den - Hızla Kirala\'da hemen kirala.',
  ...
  // 3 - Dyson Airstrait Prusya Mavisi (ıslak/kuru düzleştirici)
  {
    ...
    categoryHref: `${PARTNER_BASE}/urunler/kategori/sac-sakal-bakim-urunleri-kiralama`,
    subCategory: 'Saç Bakımı',
    audience: 'Plakasız ve ıslak saçta düzleştirme arayan, saç sağlığını koruyarak profesyonel sonuç isteyenler.',
    keywords: ['dyson airstrait kiralama', 'plakasiz sac duzlestirici', 'islak sac duzlestirici kiralama', 'kuru sac duzlestirme', 'dyson prusya mavisi', 'sac saglikli duzlestirici', 'asagi hava akimi duzlestirici', 'premium duzlestirici', 'aylik sac kirala', 'on music kiralama'],
    series: 'Saç düzleştirici · Dyson Airstrait serisi',
    short: 'Dyson Airstrait, ısıtmalı plaka yerine yüksek basınçlı hava akımıyla saçı düzleştirir - saç kütikülüne minimum hasar. Islak veya kuru saçta tek dokunuşta düzleştirme, Hızla Kirala\'da aylık 1.400 TL\'den kiralık premium cihaz.',
  ...
  // 4 - FOREO FAQ 202 LED Yüz Maskesi
  {
    ...
    audience: 'Klinik düzeyde anti-aging arayan, evinde profesyonel LED maske tedavisi uygulamak isteyenler.',
    keywords: ['foreo faq 202 kiralama', 'led yuz maskesi kiralama', '8 led dalga uzunlugu', 'nir cilt bakimi', 'klinik anti aging', 'foreo turkiye kirala', 'lazer led maske', 'kollajen led tedavi', 'aylik cilt bakim', 'profesyonel maske evde'],
    series: 'Cilt bakım cihazı · FOREO FAQ serisi',
    short: 'FOREO FAQ 202 LED yüz maskesi, 8 farklı LED ışık dalgası ve NIR (Yakın Kızılötesi) teknolojisi ile cilt yenilenmesi sağlar. Kırışıklık, sivilce ve cilt tonu eşitsizliğine karşı klinik kanıtlanmış cilt bakım cihazı - Hızla Kirala\'da aylık 3.750 TL\'den.',
  ...
  // 5 - Xiaomi Mi Pro 4 Scooter
  {
    ...
    subCategory: 'Mikro Mobilite',
    audience: 'Şehir içi ulaşımda hızlı ve sürdürülebilir alternatif arayan iş insanları, öğrenciler ve gezginler.',
    keywords: ['xiaomi mi pro 4 kiralama', 'elektrikli scooter kiralama', 'sehir ici scooter', '45 km menzil scooter', '25 kmh scooter', 'mikro mobilite kirala', 'xiaomi scooter aylik', 'is ulasimi scooter', 'sehir transport', 'on music kiralama'],
    series: 'Mikro mobilite · Xiaomi Mi serisi',
    short: 'Xiaomi Mi Pro 4, 350W motor + 474Wh batarya ile 45 km menzil sunan elektrikli scooter. Şehir içi günlük ulaşım, kısa kiralık ev konaklaması veya etkinlik transferi için Hızla Kirala\'da aylık 2.350 TL\'den kiralama.',
  ...
  // 6 - Philips GC810/20 Buharlı Düzleştirici
  {
    ...
    subCategory: 'Buharlı Ütü',
    audience: 'İş seyahati, etkinlik veya hızlı kıyafet düzeltme arayan; askıda buharlı ütü kullanmak isteyenler.',
    keywords: ['philips gc810 kiralama', 'el tipi buharli duzlestirici', 'dikey buharli utu', '30 saniye isinma utu', 'philips gc serisi', 'is seyahati utu', 'etkinlik kiyafet utu', 'kiyafet duzeltici', 'aylik utu kirala', 'hizla kirala philips'],
    series: 'Kişisel bakım · Philips Steam serisi',
    short: 'Philips GC810/20 el tipi buharlı düzleştirici, dikey kıyafet ütüsü için 30 saniyede hazır. Otel odası, geçici konaklama veya yurtdışı seyahat için Hızla Kirala\'da aylık 500 TL\'den kiralık. Asılı kıyafette buruşukluğu anında giderir.',
  ...
  // 7 - Vahaa Akıllı Bahçe
  {
    ...
    audience: 'Şehir içinde organik mikro yeşillik yetiştirmek isteyen apartman sakinleri ve sağlıklı yaşam meraklıları.',
    keywords: ['vahaa akilli bahce kiralama', 'topraksiz tarim cihazi', 'ev bahcesi kiralama', 'iot tarim kirala', 'wifi kontrolu bahce', '6 kapsul tarim sistemi', 'akilli ev urunu kirala', 'mikro yesillik yetistirme', 'aylik akilli bahce', 'on music akilli ev'],
    series: 'Akıllı bahçe · Vahaa serisi',
    short: 'Vahaa Akıllı Bahçe, 6 kapsüllü topraksız tarım cihazı ile evinizde taze fesleğen, kekik, marul, çilek yetiştirin. IoT destekli, su seviyesi + LED ışık otomatik. Aylık 890 TL\'den kiralık akıllı ev bahçesi - Hızla Kirala\'da hemen kirala.',
  ...
  // 8 - Anker Nebula Apollo
  {
    ...
    audience: 'Lansman, sunum, etkinlik veya ev sineması için 200 ANSI lümen taşınabilir projeksiyon arayan profesyoneller ve aileler.',
    keywords: ['anker nebula apollo kiralama', 'tasinabilir projeksiyon kiralama', '200 ansi lumen projeksiyon', 'android tv projeksiyon', 'ev sinemasi projeksiyon', 'lansman projeksiyon', 'sunum projeksiyon', 'pil destekli projeksiyon', 'aylik projeksiyon kirala', 'nebula apollo turkiye'],
    series: 'Projeksiyon · Anker Nebula serisi',
    short: 'Anker Nebula Apollo, 200 ANSI lümen parlaklık, dahili Android TV ve 4 saat batarya ile cep boyutunda projeksiyon. Cafe açılışı, dış mekan etkinlik, geçici sinema kurulumu için Hızla Kirala\'da aylık 1.850 TL\'den kiralık.',
  ...
  // 9 - Dreame PM10 Hava Temizleyici
  {
    ...
    audience: 'Astım, alerji veya yüksek polen hassasiyeti olan ailelerin yaşam alanı için HEPA hava temizleme arayanlar.',
    keywords: ['dreame pm10 kiralama', 'akilli hava temizleyici', 'hepa h13 filtre', '60 m2 kapsama temizleyici', 'alerji hava temizleyici', 'astim filtre cihazi', 'iot hava temizleyici', 'akilli ev hava', 'aylik hava temizleyici', 'hizla kirala dreame'],
    series: 'Ev aletleri · Dreame serisi',
    short: 'Dreame PM10, HEPA filtre + UV-C sterilizasyon + serinletici fan tek cihazda. PM2.5 partikül, polen, bakteri ve virüsü yakalar; yaz aylarında oda fanı, dört mevsim akıllı hava temizleyici. Aylık 1.700 TL\'den - Hızla Kirala\'da hemen kirala.',
  ...
  // 10 - Dyson Purifier Cool Hava Temizleyici
  {
    ...
    categoryHref: `${PARTNER_BASE}/urunler/kategori/hava-temizleyici-cihaz-kiralama`,
    subCategory: 'Hava Temizleyici',
    audience: 'Yaz aylarında hem soğutma hem hava temizleme arayan, gerçek HEPA + cooling fan kombinasyonu isteyenler.',
    keywords: ['dyson purifier cool kiralama', 'dyson hava temizleyici', 'hepa h13 cooling', '350 derece osilasyon fan', 'sogutma fan temizleyici', 'tower fan hava', 'akilli hava temizleyici', 'yaz hava temizleme', 'aylik dyson kirala', 'on music dyson'],
    series: 'Ev aletleri · Dyson Purifier serisi',
    short: 'Dyson Purifier Cool, HEPA H13 filtreli + 350° dönen serinletici fan ile yaz-kış kullanılan akıllı hava temizleyici. PM0.1\'e kadar partikül, polen, koku ve gaz yakalama; Hızla Kirala\'da aylık 2.500 TL\'den premium kiralık.',
  ...
  // 11 - Karaca Robotea Pro 4-in-1 Çay Makinesi
  {
    ...
    audience: 'Geleneksel Türk çayı deneyimini otomatik hale getirmek isteyen ofisler, kafeler ve ev kullanıcıları.',
    keywords: ['karaca robotea pro kiralama', 'akilli cay makinesi', 'sesli asistan cay makinesi', '2.5 litre cay makinesi', 'ofis cay makinesi', 'kafe cay sistemi', 'otomatik demlik kirala', 'turk cayi makinesi', 'aylik mutfak kirala', 'hizla kirala karaca'],
    series: 'Mutfak aletleri · Karaca Robotea serisi',
    short: 'Karaca Robotea Pro, çay demleme + kahve ısıtma + su kaynatma + bebek sütü hazırlama 4 fonksiyonu bir arada. Sesli asistan çayınızın hazır olduğunu söyler. Aylık 1.350 TL\'den kiralık akıllı çay makinesi - Hızla Kirala\'da hemen kirala.',
  ...
  // 12 - Karcher SC 3 EasyFix Buharlı Temizlik
  {
    ...
    subCategory: 'Buharlı Temizlik',
    audience: 'Kimyasalsız yüksek hijyen arayan aileler; mutfak, banyo, fayans ve mobilya buhar temizliği yapanlar.',
    keywords: ['karcher sc3 kiralama', 'buharli temizleyici kiralama', '3.5 bar buhar temizleyici', 'kimyasalsiz temizlik', 'fayans buhar temizligi', 'banyo derin temizlik', 'mutfak buhar temizleyici', 'evcil hayvan temizligi', 'aylik karcher kirala', 'hijyen ev temizlik'],
    series: 'Ev aletleri · Kärcher Steam serisi',
    short: 'Kärcher SC 3 EasyFix, 3.5 bar basınçlı buharla zemini, mutfak yüzeyini, banyoyu ve halıları kimyasalsız temizler. Bakteriyi öldürür, alerjeni nötralize eder. Yeni eve taşınma veya derin temizlik için Hızla Kirala\'da aylık 1.980 TL\'den.',
  ...
  // 13 - Dyson V15 Detect Süpürge
  {
    ...
    subCategory: 'Süpürge',
    audience: 'Kıl döken evcil hayvan sahipleri, alerji hastaları ve toz görselleştirme isteyen titiz ev sahipleri.',
    keywords: ['dyson v15 detect kiralama', 'kablosuz dik supurge kirala', 'lazer toz detection', 'hepa supurge kirala', 'evcil hayvan supurge', 'alerji supurge', 'dyson piezo sensor', 'akilli supurge', 'aylik supurge kirala', 'on music dyson v15'],
    series: 'Ev aletleri · Dyson V serisi',
    short: 'Dyson V15 Detect, yeşil lazer ışını ile gözle görünmeyen tozu görünür kılar. LCD ekranda parçacık sayımı canlı; HEPA filtre + 60 dakika pil ile evdeki en güçlü kablosuz süpürge. Aylık 1.600 TL\'den - Hızla Kirala\'da hemen kirala.',
  ...
  // 14 - Cybex Anoris T i-Size Bebek Oto Koltuğu
  {
    ...
    subCategory: 'Oto Koltuğu',
    audience: 'Bebek güvenliğine yatırım yapmak isteyen ebeveynler; ECE R129 i-Size standardı arayan modern aileler.',
    keywords: ['cybex anoris t kiralama', 'bebek oto koltugu kiralama', 'i-size oto koltuk', 'tam vucut hava yastigi', 'sertifikali bebek koltuğu', '76-115 cm cocuk koltugu', 'cybex platinum kirala', 'aylik bebek koltugu', 'guvenli yolculuk', 'hizla kirala bebek'],
    series: 'Anne & bebek · Cybex Premium serisi',
    short: 'Cybex Anoris T, dünyada ilk tam vücut hava yastıklı bebek oto koltuğu - yan çarpışmada %50 daha az darbe. i-Size sertifikalı, 76-115 cm çocuk için 15 ay - 6 yaş arası. Aylık 3.350 TL\'den kiralık premium güvenlik - Hızla Kirala\'da hemen kirala.',
  ...
  // 15 - Sony PlayStation 5 Slim
  {
    ...
    subCategory: 'Konsol',
    audience: 'Yeni nesil oyun deneyimi yaşamak isteyen oyuncular, etkinlik organizatörleri ve aile salonu kurulumları.',
    keywords: ['playstation 5 slim kiralama', 'ps5 slim kiralama', '4k 120 fps konsol', '1tb ssd oyun konsolu', 'sony ps5 turkiye', 'oyun konsolu aylik', 'dualsense controller', 'event ps5 kirala', 'aile salonu oyun', 'on music ps5'],
    series: 'Oyun konsolu · PlayStation 5 serisi',
    short: 'Sony PS5 Slim 1TB, 4K 120 FPS ray tracing destekli yeni nesil oyun konsolu. 2 DualSense kontrolcü dahil - LAN parti, etkinlik aktivasyonu veya salon kullanımı için Hızla Kirala\'da aylık 1.850 TL\'den kiralık.',
  ...
  // 16 - Meta Quest 3 VR
  {
    ...
    subCategory: 'VR',
    audience: 'Sanal gerçeklik deneyimi yaşamak isteyen oyuncular, eğitimciler ve karma gerçeklik projeleri yapanlar.',
    keywords: ['meta quest 3 kiralama', 'vr gozluğu kiralama', '128gb meta quest', 'karma gerceklik vr', '4k lcd vr ekran', 'oculus turkiye', 'meta vr aylik', 'oyun vr kirala', 'egitim vr', 'event vr cihazi'],
    series: 'VR · Meta Quest serisi',
    short: 'Meta Quest 3, Snapdragon XR2 Gen 2 + 4K LCD panel + renkli passthrough karma gerçeklik gözlüğü. Lansman demosu, eğitim simülasyonu veya gaming için Hızla Kirala\'da aylık 2.300 TL\'den 128GB premium VR seti.',
  ...
  // 17 - Nintendo Switch OLED
  {
    ...
    categoryHref: `${PARTNER_BASE}/urunler/kategori/oyun-konsolu-ve-cihazlari-kiralama`,
    subCategory: 'Konsol',
    audience: "Hem TV'de hem mobil oynamak isteyen aileler, küçük çocuklar ve çoklu oyuncu eğlencesi arayanlar.",
    keywords: ['nintendo switch oled kiralama', 'switch oled 64gb', 'el konsolu kiralama', 'tv dock switch', 'aile oyun konsolu', 'cocuk oyun cihazi', 'nintendo turkiye', '7 inc oled ekran', 'aylik nintendo kirala', 'cocuk hediye konsol'],
    series: 'Oyun konsolu · Nintendo Switch serisi',
    short: 'Nintendo Switch OLED, 7 inç canlı OLED ekran + çıkarılabilir Joy-Con + TV dock\'lu hibrit konsol. Etkinlik aktivasyonu, çocuk partisi, salon kullanımı için Hızla Kirala\'da aylık 1.030 TL\'den kiralık.',
  ...
  // 18 - DJI Osmo Pocket 3 Creator Combo
  {
    ...
    audience: 'Vlogger, içerik üreticisi, etkinlik fotoğrafçısı ve seyahat eden profesyoneller için 4K stabilize çekim.',
    keywords: ['dji osmo pocket 3 kiralama', 'gimbal kamera kiralama', '1 inc sensor kamera', '4k 120 fps gimbal', 'vlog kamerasi kirala', 'icerik uretici kamera', 'osmo creator combo', 'seyahat kamerasi', 'aylik dji kirala', 'on music dji'],
    series: 'Vlog kamera · DJI Osmo Pocket serisi',
    short: 'DJI Osmo Pocket 3, 1 inç CMOS sensör + 3 eksen mekanik gimbal + 4K/120 FPS video çekim. Vlogger, content creator, etkinlik kayıt için Hızla Kirala\'da aylık 2.450 TL\'den kiralık premium gimbal kamera.',
  ...
  // 19 - Apple iPhone 17 Pro
  {
    ...
    subCategory: 'iPhone',
    audience: 'Premium iPhone deneyimini denemek isteyen kullanıcılar, mevcut hattını korumak isteyen kurumsal alıcılar.',
    keywords: ['iphone 17 pro kiralama', 'apple iphone 17 pro 256gb', 'kozmik turuncu iphone', 'a19 pro cipset', '48mp triple kamera', 'titanyum iphone', 'aylik iphone kirala', 'kurumsal iphone', 'denemek iphone', 'on music iphone'],
    series: 'iPhone · Apple Pro serisi',
    short: 'Apple iPhone 17 Pro 256GB Kozmik Turuncu, A19 Pro çip + titanium gövde + 48MP triple kamera. Premium kullanım, sosyal medya çekimi, lansman vlog için Hızla Kirala\'da aylık 7.500 TL\'den kiralık 2026\'nın en iddialı telefonu.',
  ...
  // 20 - Apple MacBook Neo 12" M4
  {
    ...
    subCategory: 'MacBook',
    audience: 'Hafif taşınabilirlik + Apple Silicon performansı arayan tasarımcılar, geliştiriciler ve içerik üreticileri.',
    keywords: ['macbook neo m4 kiralama', 'apple macbook 12 inc', 'm4 cipset macbook', '16gb ram 512gb ssd', '18 saat pil macbook', 'tasarimci macbook', 'gelistirici macbook', 'icerik uretici', 'aylik macbook kirala', 'kurumsal mac'],
    series: 'Laptop · Apple silikon serisi',
    short: 'Apple MacBook Neo 12 inç, M4 çip + 16GB unified memory + 512GB SSD ile 1.1 kg taşınabilir performans. Sunum, video düzenleme, mobil ofis için Hızla Kirala\'da aylık 2.450 TL\'den kiralık premium ultrabook.',
